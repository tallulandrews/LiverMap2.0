...
liver.integrated <- liver.integrated[,liver.integrated@meta.data$Fine_clusters %in% c(10, 13, 14)];
...
coarse_lvl <- "knn_50_res_0.9" 
fine_lvl <- "knn_70_res_1.1"
