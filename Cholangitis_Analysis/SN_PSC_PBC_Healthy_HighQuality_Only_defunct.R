...
PSC = c(
	...
	"/cluster/projects/macparland/TA/PSC/Processed/PSC014_Section3_Nuclei_EmptyOnly.rds"
	)
...
for (i in 1:length(all_samples)) {
	...
	if (is.null(merged_obj)) {
		...
		# All genes
		merged_obj <- merge(merged_obj, obj, add.cell.ids=c("", n), project="SN_IntegratedMap");
